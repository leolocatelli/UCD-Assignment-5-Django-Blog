...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'leodublin33@gmail.com' #os.environ.get('EMAIL_USER') # Login email address, Stored as an environment varaible
EMAIL_HOST_PASSWORD = 'ipma rzez lqoc fsfo'  #os.environ.get('EMAIL_PASS') 
